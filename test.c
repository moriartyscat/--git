...
/*【2】学号查询*/
    ...
    {	void menu_print_out(void);	
    struct Student *pt;	char str_num[10];	
    printf("◎请输入您要查询的学号:");	
    scanf("%s", str_num);	
    pt = ReadData();	
    menu_print_out();	
...
/*【3】姓名查询*/
            ...
            {	
                void menu_print_out(void);	
                struct Student *pt;	char str_name[20];	
                printf("◎请输入您要查询的姓名:");	
                scanf("%s", str_name);	
                pt = ReadData();	
                menu_print_out();	
                do {		
                    ...
                    {			
                        ...
                        {	void menu_print_out(void);	
                        struct Student *pt;	char str_find[20];	
                        int m = 0;	printf("◎请输入您要查询的关键词:");	
                        scanf("%s", str_find);	pt = ReadData();	
                        menu_print_out();	
                        do {		
...
/*成绩统计*/
    ...
    {	struct Student *head, *p1;	float CMIN, CMAX, EMIN, EMAX, SMIN, SMAX;	head = ReadData();	p1 = head;	CMIN = CMAX = p1->cscore;	EMIN = EMAX = p1->escore;	SMIN = SMAX = p1->cscore + p1->escore;	
                                while(p1->next!=NULL) 
                                {		
                                    if(p1->cscore > CMAX) 
                                    {			CMAX = p1->cscore;		}		
        	...
        	while(pt2!=NULL)
             {
                ...
                {	menu_print_in();			
                    ...
                    {	menu_print_in();			
                        ...
                        if(pt2!=NULL)	printf("数据库中没有存储您要删除的数据！\n");	
                        return 0;} 
                        /*【3】修改数据之整理数据*/
                        int Neaten() 
    ...
    {	
        ...
        {	
            ...
            {			
                ...
                case '6': system("cls");getchar();menu();			break;		}	}}
/*二级菜单之修改数据*/
    void menu_amend(void) 
        {	
            system("cls");	
